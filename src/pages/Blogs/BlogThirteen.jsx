      ...
      <main className="container">
        ...
        <article className="article">
          ...
          <ul className="blog-bullets">
            <li>
              <span className="boldText">Creating an async thunk</span>
            ...
            />
            <li>
              <span className="boldText">Using a slice</span> (editItemSlice) to
              keep track of the current animal being edited (item) and the
            ...
            />
            <li>
              <span className="boldText">Providing reducer actions</span>
          ...
          <ul className="blog-bullets">
            <li>
              <span className="boldText">Required labels on form inputs</span> -
              All forms include required fields. Instead of letting users submit
              an empty form and showing an error afterward, we clearly indicate
              which inputs must be filled before submission.
            </li>
            <li>
              <span className="boldText">Editing animals </span> – When a user
            ...
            <li>
              <span className="boldText">Breadcrumbs</span> – Instead of relying
              on URL paths, users can navigate back through the site using
              breadcrumb navigation, making it easier to understand where they
              are and return to previous pages.
            </li>
          </ul>
